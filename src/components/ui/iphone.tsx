...
export function Iphone({
  ...
  const maskId = useId()
  const screenPunchId = `${maskId}-screen-punch`
  ...
  return (
    ...
    >
      {!hasVideo && !src ? (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden bg-[linear-gradient(180deg,color-mix(in_srgb,var(--primary)_14%,transparent),color-mix(in_srgb,var(--muted)_75%,transparent))]"
          style={screenStyle}
        />
      ) : null}
