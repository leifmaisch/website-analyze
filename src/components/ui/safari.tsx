...
export function Safari({
  ...
  return (
    ...
    >
      {!hasVideo && !imageSrc ? (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden bg-[linear-gradient(180deg,color-mix(in_srgb,var(--primary)_12%,transparent),color-mix(in_srgb,var(--muted)_80%,transparent))]"
          style={screenStyle}
        />
      ) : null}
      ...
      >
        <defs>
          <mask id={safariPunchId} maskUnits="userSpaceOnUse">
            <rect
              x="0"
              y="0"
              width={SAFARI_WIDTH}
        ...
        <g clipPath={`url(#${path0Id})`} mask={hasMedia ? `url(#${safariPunchId})` : undefined}>
          <path
